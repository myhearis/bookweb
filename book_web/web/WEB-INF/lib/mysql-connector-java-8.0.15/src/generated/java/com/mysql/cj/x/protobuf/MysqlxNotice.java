...
public final class MysqlxNotice {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public Scope getScope() {
      @SuppressWarnings("deprecation")
      Scope result = Scope.valueOf(scope_);
  ...
  bitField0_ |= 0x00000004;
    ...
    @Deprecated public static final com.google.protobuf.Parser<Frame>
  ...
  bitField0_ |= 0x00000004;
    ...
    @Deprecated public static final com.google.protobuf.Parser<Warning>
  ...
  private static final long serialVersionUID = 0L;
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              value_ = input.readMessage(MysqlxDatatypes.Scalar.PARSER, extensionRegistry);
              if (subBuilder != null) {
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return MysqlxNotice.internal_static_Mysqlx_Notice_SessionVariableChanged_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SessionVariableChanged.class, Builder.class);
    }
    ...
    public MysqlxDatatypes.Scalar getValue() {
      return value_ == null ? MysqlxDatatypes.Scalar.getDefaultInstance() : value_;
    }
    /**
     * <code>optional .Mysqlx.Datatypes.Scalar value = 2;</code>
     */
    ...
    public static SessionVariableChanged parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static SessionVariableChanged parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static SessionVariableChanged parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SessionVariableChanged parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static final class Builder extends
      ...
      public SessionVariableChanged build() {
        SessionVariableChanged result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Builder mergeFrom(SessionVariableChanged other) {
        if (other == SessionVariableChanged.getDefaultInstance()) return this;
        if (other.hasParam()) {
          bitField0_ |= 0x00000001;
          param_ = other.param_;
          onChanged();
  ...
  bitField0_ |= 0x00000001;
      ...
      private MysqlxDatatypes.Scalar value_ = null;
      private com.google.protobuf.SingleFieldBuilderV3<
          MysqlxDatatypes.Scalar, MysqlxDatatypes.Scalar.Builder, MysqlxDatatypes.ScalarOrBuilder> valueBuilder_;
      /**
       * <code>optional .Mysqlx.Datatypes.Scalar value = 2;</code>
       */
      public boolean hasValue() {
      ...
      public Builder mergeValue(MysqlxDatatypes.Scalar value) {
        if (valueBuilder_ == null) {
          if (((bitField0_ & 0x00000002) == 0x00000002) &&
              value_ != null &&
              value_ != MysqlxDatatypes.Scalar.getDefaultInstance()) {
            value_ =
              MysqlxDatatypes.Scalar.newBuilder(value_).mergeFrom(value).buildPartial();
          } else {
            value_ = value;
          }
          onChanged();
      ...
      public MysqlxDatatypes.ScalarOrBuilder getValueOrBuilder() {
        if (valueBuilder_ != null) {
          ...
          return value_ == null ?
              MysqlxDatatypes.Scalar.getDefaultInstance() : value_;
        }
      }
      /**
       * <code>optional .Mysqlx.Datatypes.Scalar value = 2;</code>
    ...
    @Deprecated public static final com.google.protobuf.Parser<SessionVariableChanged>
  ...
  public interface SessionStateChangedOrBuilder extends
     ...
     * <code>repeated .Mysqlx.Datatypes.Scalar value = 2;</code>
     */
    MysqlxDatatypes.Scalar getValue(int index);
    /**
     * <code>repeated .Mysqlx.Datatypes.Scalar value = 2;</code>
     */
    int getValueCount();
  ...
  private static final long serialVersionUID = 0L;
          ...
          switch (tag) {
            ...
            case 18: {
              if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
                value_ = new java.util.ArrayList<MysqlxDatatypes.Scalar>();
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return MysqlxNotice.internal_static_Mysqlx_Notice_SessionStateChanged_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              SessionStateChanged.class, Builder.class);
    }
    ...
    public Parameter getParam() {
      @SuppressWarnings("deprecation")
      Parameter result = Parameter.valueOf(param_);
      return result == null ? Parameter.CURRENT_SCHEMA : result;
    }

    public static final int VALUE_FIELD_NUMBER = 2;
    private java.util.List<MysqlxDatatypes.Scalar> value_;
    /**
     * <code>repeated .Mysqlx.Datatypes.Scalar value = 2;</code>
     */
    public java.util.List<MysqlxDatatypes.Scalar> getValueList() {
      return value_;
    }
    /**
     * <code>repeated .Mysqlx.Datatypes.Scalar value = 2;</code>
    ...
    public static SessionStateChanged parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static SessionStateChanged parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static SessionStateChanged parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static SessionStateChanged parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static final class Builder extends
      ...
      public SessionStateChanged build() {
        SessionStateChanged result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Builder mergeFrom(SessionStateChanged other) {
        if (other == SessionStateChanged.getDefaultInstance()) return this;
        if (other.hasParam()) {
      ...
      private void ensureValueIsMutable() {
        if (!((bitField0_ & 0x00000002) == 0x00000002)) {
          value_ = new java.util.ArrayList<MysqlxDatatypes.Scalar>(value_);
          bitField0_ |= 0x00000002;
         }
      }
    ...
    @Deprecated public static final com.google.protobuf.Parser<SessionStateChanged>
  ...
  private static final long serialVersionUID = 0L;
    ...
    protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      ...
      return MysqlxNotice.internal_static_Mysqlx_Notice_GroupReplicationStateChanged_fieldAccessorTable
          .ensureFieldAccessorsInitialized(
              GroupReplicationStateChanged.class, Builder.class);
    }
    ...
    public static GroupReplicationStateChanged parseFrom(
        java.nio.ByteBuffer data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    ...
    public static GroupReplicationStateChanged parseFrom(byte[] data)
        throws com.google.protobuf.InvalidProtocolBufferException {
      return PARSER.parseFrom(data);
    }
    public static GroupReplicationStateChanged parseFrom(
    ...
    public static GroupReplicationStateChanged parseFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseWithIOException(PARSER, input);
    }
    ...
    public static GroupReplicationStateChanged parseDelimitedFrom(java.io.InputStream input)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
          .parseDelimitedWithIOException(PARSER, input);
    }
    public static GroupReplicationStateChanged parseDelimitedFrom(
        java.io.InputStream input,
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      return com.google.protobuf.GeneratedMessageV3
    ...
    public static final class Builder extends
      ...
      public GroupReplicationStateChanged build() {
        GroupReplicationStateChanged result = buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
        return result;
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof GroupReplicationStateChanged) {
          return mergeFrom((GroupReplicationStateChanged)other);
        } else {
          super.mergeFrom(other);
          return this;
        }
      ...
      public Builder mergeFrom(GroupReplicationStateChanged other) {
        if (other == GroupReplicationStateChanged.getDefaultInstance()) return this;
        if (other.hasType()) {
          setType(other.getType());
        }
        if (other.hasViewId()) {
  ...
  bitField0_ |= 0x00000002;
    ...
    @Deprecated public static final com.google.protobuf.Parser<GroupReplicationStateChanged>
