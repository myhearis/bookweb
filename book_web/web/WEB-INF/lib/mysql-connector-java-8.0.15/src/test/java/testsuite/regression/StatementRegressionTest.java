...
public class StatementRegressionTest extends BaseTestCase {
    ...
    public void testBug11540() throws Exception {
        ...
        try {
            ...
            thaiPrepStmt = ((JdbcConnection) thaiConn).clientPrepareStatement("INSERT INTO testBug11540 VALUES (?,?)");
    ...
    public void testBug11663() throws Exception {
        if (((JdbcConnection) this.conn).getPropertySet().getBooleanProperty(PropertyKey.useServerPrepStmts).getValue()) {
    ...
    public void testBug15141() throws Exception {
        try {
            ...
            this.pstmt = ((JdbcConnection) this.conn).clientPrepareStatement("select {d '1997-05-24'} FROM testBug15141");
            this.rs = this.pstmt.executeQuery();
            assertTrue(this.rs.next());
            assertEquals("1997-05-24", this.rs.getString(1));
            this.rs.close();
    ...
    public void testSetCharacterStream() throws Exception {
        try {
            ((JdbcConnection) this.conn).getPropertySet().getBooleanProperty(PropertyKey.traceProtocol).setValue(true);
            ...
            ((JdbcConnection) this.conn).getPropertySet().getBooleanProperty(PropertyKey.traceProtocol).setValue(false);
    ...
    public void testBug17099() throws Exception {
        ...
        pStmt = ((JdbcConnection) this.conn).clientPrepareStatement("SELECT 1", Statement.RETURN_GENERATED_KEYS);
        assertNotNull(pStmt.getGeneratedKeys());
    }
    ...
    public void testBug17587() throws Exception {
        ...
        try {
            ...
            pStmt = ((JdbcConnection) this.conn).clientPrepareStatement("INSERT INTO testBug17857 VALUES (?)");
            pStmt.close();
            try {
                pStmt.clearParameters();
            } catch (SQLException sqlEx) {
    ...
    public void testBug19615() throws Exception {
        ...
        this.pstmt = ((JdbcConnection) this.conn).clientPrepareStatement("INSERT INTO testBug19615 VALUES (?)");
        this.pstmt.setObject(1, dec, Types.DECIMAL);
        this.pstmt.executeUpdate();
        this.pstmt.close();
    ...
    public void testBug20029() throws Exception {
        ...
        for (int i = 0; i < 10; i++) {
            ...
            try {
                toBeKilledPstmt = ((JdbcConnection) toBeKilledConn).clientPrepareStatement("INSERT INTO testBug20029 VALUES (?)");
    ...
    public void testBug20888() throws Exception {
        ...
        this.pstmt = ((JdbcConnection) this.conn).clientPrepareStatement(s);
    ...
    public void testBug21438() throws Exception {
        ...
        this.pstmt = ((JdbcConnection) this.conn)
    ...
    public void testBug22290() throws Exception {
        ...
        try {
            ...
            this.pstmt = ((JdbcConnection) configuredConn).clientPrepareStatement("update testbug22290 set cost = cost + ? where id = 1");
            this.pstmt.setBigDecimal(1, new BigDecimal("1.11"));
            assertEquals(this.pstmt.executeUpdate(), 1);
        } finally {
    ...
    public void testClientPreparedSetBoolean() throws Exception {
        this.pstmt = ((JdbcConnection) this.conn).clientPrepareStatement("SELECT ?");
    ...
    public void testBug25073() throws Exception {
        ...
        int beforeOpenStatementCount = ((JdbcConnection) multiConn).getActiveStatementCount();

        multiStmt.executeBatch();

        int afterOpenStatementCount = ((JdbcConnection) multiConn).getActiveStatementCount();
        ...
        beforeOpenStatementCount = ((JdbcConnection) multiConn).getActiveStatementCount();

        multiStmt.executeBatch();

        afterOpenStatementCount = ((JdbcConnection) multiConn).getActiveStatementCount();
    ...
    public void testBug28256() throws Exception {
        try {
            ...
            ((JdbcConnection) this.conn).serverPrepareStatement("(SELECT 1) UNION (SELECT 2)").execute();
        } finally {
    ...
    public void testBug28851() throws Exception {
        this.pstmt = ((JdbcConnection) this.conn).clientPrepareStatement("SELECT 1/?");
        this.pstmt.setInt(1, 1);
        this.rs = this.pstmt.executeQuery();
    ...
    public void testBug28596() throws Exception {
        ...
        this.pstmt = ((JdbcConnection) this.conn).clientPrepareStatement(query);
        this.pstmt.setInt(1, 1);
    ...
    public void testBustedGGKColumnNames() throws Exception {
        ...
        this.pstmt = ((JdbcConnection) this.conn).serverPrepareStatement("INSERT INTO testBustedGGKColumnNames VALUES (null)",
                Statement.RETURN_GENERATED_KEYS);
        this.pstmt.executeUpdate();
        assertEquals("GENERATED_KEY", this.pstmt.getGeneratedKeys().getMetaData().getColumnName(1));
    ...
    public void testBug34518() throws Exception {
        ...
        int stmtCount = ((JdbcConnection) fetchConn).getActiveStatementCount();

        fetchStmt.setFetchSize(100);
        this.rs = fetchStmt.executeQuery("SELECT 1");

        assertEquals(((JdbcConnection) fetchConn).getActiveStatementCount(), stmtCount + 1);
        this.rs.close();
        assertEquals(((JdbcConnection) fetchConn).getActiveStatementCount(), stmtCount);
    }
    ...
    public void testBug35666() throws Exception {
        ...
        this.pstmt = ((JdbcConnection) loggingConn).serverPrepareStatement("SELECT SLEEP(4)");
        this.pstmt.execute();
    }
            ...
            if ("YES".equalsIgnoreCase(enginesRs.getString("Support")) || "DEFAULT".equalsIgnoreCase(enginesRs.getString("Support"))) {
                ...
                try {
                    for (int i = 0; i < 2; i++) {
                        ...
                        ((JdbcConnection) twoConn).getPropertySet().getBooleanProperty(PropertyKey.rewriteBatchedStatements).setValue(i == 1);
    ...
    public void testBug44056() throws Exception {
        ...
        try {
            ...
            this.pstmt = ((JdbcConnection) this.conn).serverPrepareStatement("INSERT INTO testBug44056 VALUES (null)",
                    Statement.RETURN_GENERATED_KEYS);
            this.pstmt.executeUpdate();
            checkOpenResultsFor44056(this.pstmt);
        } finally {
    ...
    private void checkOpenResultsFor44056(Statement newStmt) throws SQLException {
        ...
        assertEquals(0, ((JdbcStatement) newStmt).getOpenResultSetCount());
        this.rs.close();
        assertEquals(0, ((JdbcStatement) newStmt).getOpenResultSetCount());
    }
    ...
    public void testBug61501() throws Exception {
        ...
        this.pstmt = ((JdbcConnection) this.conn).serverPrepareStatement(sql);
        this.pstmt.execute();
        this.pstmt.cancel();
        this.pstmt.execute();
    ...
    public void testBug78313() throws Exception {
        ...
        this.stmt = testConn.createStatement();
        Statement unwrappedStmt = this.stmt.unwrap(JdbcStatement.class);
        assertTrue(unwrappedStmt.getClass().getName().matches("^(?:com\\.sun\\.proxy\\.)?\\$Proxy\\d*"));
        assertTrue(unwrappedStmt.equals(unwrappedStmt));
        this.pstmt = testConn.prepareStatement("SELECT 'testBug78313'");
        Statement unwrappedPstmt = this.pstmt.unwrap(JdbcStatement.class);
